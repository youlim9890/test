$(function () {
  ...
  if (width_size < 1220) {
    ...
    const ticket_wrap = document.querySelector(".ticket");
    const con2 = document.querySelector(".con2");
    const con3 = document.querySelector(".con3");
    const inner = document.querySelector(".inner");
    const inner_wrap = document.querySelector(".inner_wrap");
    ...
    const inner_wrapHeight = inner_wrap.offsetHeight;
    const ticketHeight = ticket.offsetHeight;
    con1.style.height = `${innerHeight + header}px`;
    con2.style.height = `${innerHeight + header}px`;
    ticket_wrap.style.height = `${ticketHeight + header}px`;
  }
  if (width_size < 780) {
    /*content height*/
    const parentElement = document.querySelector("#visual");
    ...
    const inner_wrapHeight = inner_wrap.offsetHeight;
    const ticketHeight = ticket.offsetHeight;
    con1.style.height = `${ticketHeight + header + header}px`;
    con2.style.height = `${innerHeight + header}px`;
    ticket_wrap.style.height = `${ticketHeight + header}px`;
  }
  ...
  $(".scroll_section_wrap").on("scroll", function () {
    ...
    if ($(".scroll_section_wrap").scrollTop() > 3082) {
      if ($(".scroll_section_wrap").scrollTop() > $(".con3").offset().top) {
        $(".con3").addClass("on");
      } else {
        $(".con3").removeClass("on");
